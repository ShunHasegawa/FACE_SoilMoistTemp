...
DeepSoilMoist_graphs <- function(filename,parameters,savefile,figname,figtitle,figleg="topleft"){
  ...
  moist_graph.png(dataset=filename,title=figtitle,legend.location=figleg)
  dev.off()
  return(filename)
  }  
