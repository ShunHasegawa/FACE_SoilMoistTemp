...
# There are some weird values so remove so need to clean up data. NOTE: need to
# check again I just do it quickly this time.
...
# VWC is soil moisture so can't be larger than 1 (or evern 0.4)
allsoil <- subset(allsoil,VWC_1_Avg < 1 & VWC_2_Avg <1)

# Most of the probes are not working properly in the 1-2nd weeks so remove all
# data till till ##August## for the time being
